    ...
    <header class="p-5 border-b bg-white shadow">
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="flex gap-2 items-center">
                ...
                <a class="flex items-center space-x-3 bg-white border p-2 text-gray-600 rounded text-sm uppercase font-bold cursor-pointe" href="{{ route('posts.create') }}">
                ...
                <a class="font-bold uppercase text-gray-600 text-sm" href="">Muro</a>
